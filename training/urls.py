...
urlpatterns = [
    ...
    path('admin/chapter/<int:chapter_id>/edit/', views.chapter_edit, name='chapter_edit'),
    path('admin/chapter/<int:chapter_id>/delete/', views.chapter_delete, name='chapter_delete'),
