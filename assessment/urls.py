...
urlpatterns = [
    ...
    path('dashboard/org/dept-head/add/', hrm_views.org_dept_head_add, name='org_dept_head_add'),
    path('dashboard/org/dept-head/edit/<int:pk>/', hrm_views.org_dept_head_edit, name='org_dept_head_edit'),
    path('dashboard/org/dept-head/delete/<int:pk>/', hrm_views.org_dept_head_delete, name='org_dept_head_delete'),
