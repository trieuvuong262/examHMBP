...
urlpatterns = [
    ...
    path('chung-chi/<str:code>/', views_certificates.certificate_verify, name='certificate_verify'),
    ...
    path('dashboard/results/<int:exam_id>/', views.admin_results, name='admin_results_exam'),
    path('dashboard/submission/<int:submission_id>/review/', views.admin_submission_review, name='admin_submission_review'),
