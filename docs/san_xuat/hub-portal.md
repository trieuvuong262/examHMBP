...
| → Kế hoạch sản xuất (theo đơn) | `/san-xuat/ke-hoach/bang/` | SoT MTO — [ke-hoach-san-xuat.md](./ke-hoach-san-xuat.md) §0 |
| → Kế hoạch NPL | `/san-xuat/ke-hoach/npl/` | KHNVL |
| ~~KHTT / KHCT / Giám sát tiến độ~~ | URL cũ | Redirect → bảng kế hoạch |
