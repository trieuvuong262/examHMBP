...
urlpatterns = [
    ...
    path('it/ho-tro/<uuid:pk>/', views.it_repair_detail, {**_it}, name='it_repair_detail_it'),
    ...
    path('san-xuat/ho-tro/<uuid:pk>/', views.it_repair_detail, {**_production}, name='it_repair_detail_production'),
    ...
    path('ho-tro/<uuid:pk>/', views.legacy_it_repair_detail, name='it_repair_detail'),
