...
urlpatterns = [
    ...
    path('loai-thiet-bi/', views.category_list, name='category_list'),
    path('loai-thiet-bi/them/', views.category_add, name='category_add'),
    path('loai-thiet-bi/<int:pk>/sua/', views.category_edit, name='category_edit'),
    path('loai-thiet-bi/<int:pk>/xoa/', views.category_delete, name='category_delete'),
