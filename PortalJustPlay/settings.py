...
EQUIPMENT_RELAY_TIMEOUT = int(os.getenv("EQUIPMENT_RELAY_TIMEOUT", "300"))
EQUIPMENT_ENABLE_LOCAL_WMI = env_bool("EQUIPMENT_ENABLE_LOCAL_WMI", False)
EQUIPMENT_SCAN_DEFAULT_USER = os.getenv("EQUIPMENT_SCAN_DEFAULT_USER", "")
EQUIPMENT_SCAN_DEFAULT_START_IP = os.getenv("EQUIPMENT_SCAN_DEFAULT_START_IP", "")
EQUIPMENT_SCAN_DEFAULT_END_IP = os.getenv("EQUIPMENT_SCAN_DEFAULT_END_IP", "")
