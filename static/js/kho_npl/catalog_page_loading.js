...
(function (global) {
    ...
    const ROUTE_MESSAGES = {
        '/kho-npl/danh-muc/': 'Đang tải danh mục NPL…',
        '/kho-npl/ton-kho/': 'Đang tải tồn kho NPL…',
        '/kho-npl/ton-kho-npl/': 'Đang tải tồn kho NPL…',
        '/kho-npl/the-kho/': 'Đang tải thẻ kho NPL…',
        ...
        '/kho-vat-tu/danh-muc/': 'Đang tải danh mục vật tư…',
        '/kho-vat-tu/ton-kho/': 'Đang tải tồn kho vật tư…',
        '/kho-vat-tu/ton-kho-npl/': 'Đang tải tồn kho vật tư…',
        '/kho-vat-tu/the-kho/': 'Đang tải thẻ kho vật tư…',
    ...
    const DOC_DETAIL_ROUTE_PATTERNS = [
        ...
        [/^\/kho-npl\/ton-kho\/\d+\/$/, 'Đang tải chi tiết tồn kho NPL…'],
        [/^\/kho-vat-tu\/ton-kho\/\d+\/$/, 'Đang tải chi tiết tồn kho vật tư…'],
        [/^\/san-xuat\/ho-so\/them\/$/, 'Đang mở form thêm hồ sơ…'],
