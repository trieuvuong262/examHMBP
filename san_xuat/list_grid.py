...
SX_LIST_GRIDS: dict[str, dict[str, Any]] = {
    ...
    'subcontract': _spec(
        _cols(
            ...
            _col('product', 'Sản phẩm', weight=140),
            _col('team', 'Tổ Ob', weight=90),
            _col('qty', 'Số lượng', weight=80, align='end'),
            _col('order_date', 'Ngày', weight=90),
            _col('status', 'Trạng thái', weight=110),
            actions=False,
        ),
        {
            'code': 'code',
    ...
    'capacity_catalog': _spec(
        _cols(
            _col('name', 'Tổ sản xuất', required=True, weight=160),
            _col('headcount', 'Số người', weight=80, align='end'),
            _col('throughput', 'Hiệu suất (SP/s)', weight=110, align='end'),
            _col('hours', 'Thời gian làm việc', weight=130, align='end'),
            _col('load', 'Hệ số tải', weight=90, align='end'),
            _col('estimate', 'Ước lượng', weight=130, align='end', sortable=False),
            _col('location', 'Địa điểm', weight=130),
            _col('division', 'Tổ', weight=150),
            _col('capacity', 'NL/ngày', weight=90, align='end', default=False),
            _col('status', 'Trạng thái', weight=90),
            meta=True,
            actions=False,
        ),
