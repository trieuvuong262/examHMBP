...
SX_LIST_GRIDS: dict[str, dict[str, Any]] = {
    ...
    'ie_operation': _spec(
        _cols(
            ...
            _col('name_en', 'Tên EN', weight=110, sortable=False),
            ...
            _col('product_part', 'Cụm chi tiết', weight=100, sortable=False),
            _col('method_variant', 'Mô tả PP', weight=120, sortable=False),
            _col('machine_code', 'Mã máy', weight=80, sortable=False),
            _col('stitch_class', 'Nhóm mũi', weight=80, sortable=False),
            _col('thread_needle', 'Kim/chỉ', weight=80, sortable=False),
            _col('attachment', 'Cữ/gá', weight=80, sortable=False),
            _col('smv_basis', 'Đơn vị', weight=70, sortable=False),
            _col('smv_source', 'Nguồn SMV', weight=90, sortable=False),
            _col('status', 'Trạng thái', weight=90, sortable=False),
            _col('effective_from', 'Ngày HL', weight=90, sortable=False),
            _col('effective_to', 'Ngày hết HL', weight=90, sortable=False),
            _col('ie_owner', 'Người lập', weight=90, sortable=False),
            _col('approved_by', 'Người duyệt', weight=90, sortable=False),
            _col('revision_reason', 'Lý do phiên bản', weight=110, sortable=False),
            _col('notes', 'Notes', weight=100, sortable=False),
    ...
    'ie_routing': _spec(
        _cols(
            ...
            _col('product_family', 'Nhóm SP', weight=100, sortable=False),
