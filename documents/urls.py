...
urlpatterns = [
    ...
    path(
        'tai-nas/tai/',
        RedirectView.as_view(pattern_name='nas_storage:nas_download_setup', permanent=False),
        name='nas_download_setup',
    ),
    path(
        'tai-nas/',
        RedirectView.as_view(pattern_name='nas_storage:nas_download', permanent=False),
        name='nas_download',
    ),
