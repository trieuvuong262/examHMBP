...
def nas_module_nav_context(request, active: str) -> dict:
    items = []
    ...
    return {
        ...
        **menu_perm_context(request.user, MODULE_NAS_STORAGE, menu_key),
    }


def _browse_nav_context(request) -> dict:
    return nas_module_nav_context(request, 'browse')
