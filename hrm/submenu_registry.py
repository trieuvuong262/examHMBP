...
MODULE_SUBMENUS: dict[str, list[dict]] = {
    ...
    MODULE_EQUIPMENT: [
        ...
        {'key': 'production', 'label': 'Thiết bị sản xuất', 'icon': 'bi-gear-wide-connected'},
    ],
    MODULE_FEEDBACK: [
    ...
    MODULE_KHO_NPL: [
        {'key': 'materials', 'label': 'Danh mục NPL', 'icon': 'bi-tags'},
        {'key': 'material_stock', 'label': 'Tồn kho NPL', 'icon': 'bi-boxes'},
        {'key': 'stock_cards', 'label': 'Thẻ kho NPL', 'icon': 'bi-grid-3x3-gap'},
    ...
    MODULE_KHO_VAT_TU: [
        {'key': 'materials', 'label': 'Danh mục vật tư', 'icon': 'bi-tags'},
        {'key': 'material_stock', 'label': 'Tồn kho vật tư', 'icon': 'bi-boxes'},
        {'key': 'stock_cards', 'label': 'Thẻ kho vật tư', 'icon': 'bi-grid-3x3-gap'},
        {'key': 'receipts', 'label': 'Phiếu nhập', 'icon': 'bi-box-arrow-in-down'},
        {'key': 'issues', 'label': 'Phiếu xuất', 'icon': 'bi-box-arrow-up'},
        {'key': 'transfers', 'label': 'Phiếu chuyển', 'icon': 'bi-arrow-left-right'},
        {'key': 'disposals', 'label': 'Phiếu hủy', 'icon': 'bi-trash3'},
    ...
    MODULE_SAN_XUAT: [
        ...
        {
            'key': 'sx_cancel_approve',
            'label': 'Duyệt hủy sản xuất',
            'perm_label': 'Duyệt hủy sản xuất',
            'icon': 'bi-x-circle',
        },
        ...
        {'key': 'stock_policy', 'label': 'Chính sách tồn', 'icon': 'bi-sliders'},
        {'key': 'restock', 'label': 'Đề xuất bù tồn', 'icon': 'bi-arrow-repeat'},
        {'key': 'plan_audit', 'label': 'Nhật ký kế hoạch', 'icon': 'bi-journal-text'},
        ...
        {'key': 'disassembly', 'label': 'Lệnh tháo dỡ', 'icon': 'bi-scissors'},
        ...
        {'key': 'team_work_theu', 'label': 'Tổ thêu', 'icon': 'bi-flower1'},
        ...
        {'key': 'ncr', 'label': 'Không phù hợp', 'icon': 'bi-exclamation-octagon'},
        ...
        {'key': 'actual_cost', 'label': 'Giá thành thực tế', 'icon': 'bi-cash-stack'},
...
MENU_PATH_RULES: list[tuple[str, str, str]] = [
    ...
    ('/kho-npl/ton-kho', MODULE_KHO_NPL, 'material_stock'),
    ...
    ('/kho-vat-tu/thiet-lap', MODULE_KHO_VAT_TU, 'settings'),
    ('/kho-vat-tu/bao-cao', MODULE_KHO_VAT_TU, 'reports'),
    ('/kho-vat-tu/kiem-ke', MODULE_KHO_VAT_TU, 'adjustments'),
    ('/kho-vat-tu/dieu-chinh', MODULE_KHO_VAT_TU, 'adjustments'),
    ('/kho-vat-tu/phieu-huy', MODULE_KHO_VAT_TU, 'disposals'),
    ('/kho-vat-tu/chuyen-kho', MODULE_KHO_VAT_TU, 'transfers'),
    ('/kho-vat-tu/phieu-xuat', MODULE_KHO_VAT_TU, 'issues'),
    ('/kho-vat-tu/phieu-nhap', MODULE_KHO_VAT_TU, 'receipts'),
    ('/kho-vat-tu/the-kho', MODULE_KHO_VAT_TU, 'stock_cards'),
    ('/kho-vat-tu/ton-kho-npl', MODULE_KHO_VAT_TU, 'material_stock'),
    ('/kho-vat-tu/ton-kho', MODULE_KHO_VAT_TU, 'material_stock'),
    ('/kho-vat-tu/danh-muc', MODULE_KHO_VAT_TU, 'materials'),
    ('/kho-vat-tu/canh-bao', MODULE_KHO_VAT_TU, 'material_stock'),
    ('/kho-vat-tu/tong-quan', MODULE_KHO_VAT_TU, 'material_stock'),
    ...
    ('/san-xuat/ke-hoach/lo-trinh', MODULE_SAN_XUAT, 'plan_route'),
    ('/san-xuat/ke-hoach/thoi-gian-trung-gian', MODULE_SAN_XUAT, 'plan_inter_step'),
    ('/san-xuat/ke-hoach/duyet-huy', MODULE_SAN_XUAT, 'sx_cancel_approve'),
    ('/san-xuat/duyet-huy', MODULE_SAN_XUAT, 'sx_cancel_approve'),
    ('/san-xuat/ke-hoach/bang', MODULE_SAN_XUAT, 'plan_board'),
    ('/san-xuat/ke-hoach/tien-do-don', MODULE_SAN_XUAT, 'plan_progress'),
    ('/san-xuat/ke-hoach/tien-do', MODULE_SAN_XUAT, 'plan_progress'),
    ...
    ('/san-xuat/cong-viec-to/tien-do-hang-hoa', MODULE_SAN_XUAT, 'team_work_goods'),
    ('/san-xuat/cong-viec-to/cat/nhan-su', MODULE_SAN_XUAT, 'team_work_cat'),
    ('/san-xuat/cong-viec-to/inep/nhan-su', MODULE_SAN_XUAT, 'team_work_inep'),
    ('/san-xuat/cong-viec-to/theu/nhan-su', MODULE_SAN_XUAT, 'team_work_theu'),
    ('/san-xuat/cong-viec-to/may/nhan-su', MODULE_SAN_XUAT, 'team_work_may'),
    ('/san-xuat/cong-viec-to/ht/nhan-su', MODULE_SAN_XUAT, 'team_work_ht'),
    ('/san-xuat/cong-viec-to/gh/nhan-su', MODULE_SAN_XUAT, 'team_work_gh'),
    ...
    ('/san-xuat/cong-viec-to/may', MODULE_SAN_XUAT, 'team_work_may'),
    ('/san-xuat/cong-viec-to/ht', MODULE_SAN_XUAT, 'team_work_ht'),
    ('/san-xuat/cong-viec-to/gh', MODULE_SAN_XUAT, 'team_work_gh'),
    ('/san-xuat/cong-viec-to', MODULE_SAN_XUAT, 'team_work'),
    ...
    ('/san-xuat/cong-doan/duyet/cong-doan', MODULE_SAN_XUAT, 'ie_approve'),
    ('/san-xuat/cong-doan/duyet/routing', MODULE_SAN_XUAT, 'ie_approve'),
    ('/san-xuat/cong-doan/duyet', MODULE_SAN_XUAT, 'ie_approve'),
    ('/san-xuat/cong-doan/thiet-lap/nguoi-duyet', MODULE_SAN_XUAT, 'ie_settings'),
    ('/san-xuat/cong-doan/thiet-lap', MODULE_SAN_XUAT, 'ie_settings'),
    ('/san-xuat/cong-doan', MODULE_SAN_XUAT, 'ie'),
    ('/san-xuat/quy-trinh', MODULE_SAN_XUAT, 'process'),
    ('/san-xuat/ho-so/thong-ke-chi-phi', MODULE_SAN_XUAT, 'docs_cost_stats'),
...
# hình này để không hiển thị/cấp Excel hoặc In cho màn hình không có endpoint.
# CRUD chỉ bật khi màn hình có thao tác tương ứng (tạo/sửa/xoá qua form, modal
# hoặc workflow); các menu chỉ tra cứu/báo cáo chỉ có Xem.
_SAN_XUAT_MENU_ACTIONS: dict[str, frozenset[str]] = {
    'overview': frozenset({'view'}),
    'orders': frozenset({'view', 'update', 'delete', 'export'}),
    'order_create': frozenset({'view', 'create', 'update'}),
    'order_confirm': frozenset({'view', 'update'}),
    'products_nvl': frozenset({'view'}),
    'docs': frozenset({'view', 'create', 'update', 'delete', 'export'}),
    'docs_cost_stats': frozenset({'view', 'export'}),
    'bom': frozenset({'view', 'update', 'export'}),
    'ie': frozenset({'view', 'create', 'update', 'delete', 'export'}),
    'ie_settings': frozenset({'view', 'create', 'update', 'delete', 'export'}),
    'ie_approve': frozenset({'view', 'update'}),
    ...
    'plan_overall': frozenset({'view', 'create', 'update', 'delete', 'export'}),
    'plan_detail': frozenset({'view', 'create', 'update', 'delete', 'export'}),
    'plan_npl': frozenset({'view', 'create', 'update', 'delete', 'export'}),
    'npl_pr': frozenset({'view', 'create', 'update', 'delete', 'export'}),
    'purchase_order': frozenset({'view', 'create', 'update', 'delete', 'export'}),
    'stock_policy': frozenset({'view', 'update'}),
    'restock': frozenset({'view'}),
    'plan_audit': frozenset({'view'}),
    'npl_stock': frozenset({'view'}),
    'dispatch': frozenset({'view'}),
    'mo': frozenset({'view', 'create', 'update', 'delete', 'export', 'print'}),
    'disassembly': frozenset({'view', 'create', 'update', 'delete', 'export'}),
    'schedule': frozenset({'view', 'update'}),
    'material_issue_req': frozenset({'view', 'update', 'export', 'print'}),
    'prod_stats': frozenset({'view', 'create', 'update', 'delete', 'export'}),
    'handover_status': frozenset({'view'}),
    'fg_receipt_req': frozenset({'view', 'create', 'update', 'delete', 'export', 'print'}),
    'npl_surplus': frozenset({'view', 'create', 'update', 'delete', 'export'}),
    'wip_handover': frozenset({'view', 'create', 'update', 'delete', 'export', 'print'}),
    'wip_return': frozenset({'view', 'create', 'update', 'delete', 'export'}),
    'subcontract': frozenset({'view', 'create', 'update', 'delete', 'export', 'print'}),
    'packing': frozenset({'view', 'create', 'update', 'delete', 'export', 'print'}),
    'team_work': frozenset({'view', 'update'}),
    'team_work_goods': frozenset({'view'}),
    'team_work_cat': frozenset({'view', 'update'}),
    'team_work_inep': frozenset({'view', 'update'}),
    'team_work_theu': frozenset({'view', 'update'}),
    'team_work_may': frozenset({'view', 'update'}),
    'team_work_ht': frozenset({'view', 'update'}),
    'team_work_gh': frozenset({'view', 'update'}),
    'work_assign': frozenset({'view', 'create', 'update', 'delete', 'export'}),
    'shop_floor': frozenset({'view', 'update'}),
    'downtime': frozenset({'view', 'create', 'update', 'delete', 'export'}),
    'piece_rate': frozenset({'view', 'export'}),
    'qc': frozenset({'view', 'update', 'export', 'print'}),
    'qc_request': frozenset({'view', 'create', 'update', 'delete', 'export'}),
    'qc_sheet': frozenset({'view', 'create', 'update', 'delete', 'export', 'print'}),
    'ncr': frozenset({'view', 'create', 'update', 'delete', 'export', 'print'}),
    'qc_criteria': frozenset({'view', 'create', 'update', 'delete', 'export'}),
    'qc_criteria_group': frozenset({'view', 'create', 'update', 'delete', 'export'}),
    'qc_sampling': frozenset({'view', 'create', 'update', 'delete', 'export'}),
    'qc_standard_set': frozenset({'view', 'create', 'update', 'delete', 'export'}),
    'qc_defect': frozenset({'view', 'create', 'update', 'delete', 'export'}),
    'qc_defect_group': frozenset({'view', 'create', 'update', 'delete', 'export'}),
    'fg_stock': frozenset({'view'}),
    'fg_products': frozenset({'view'}),
    'fg_stock_list': frozenset({'view'}),
    'fg_purchases': frozenset({'view'}),
    'costing_hub': frozenset({'view', 'create', 'update', 'delete', 'export'}),
    'costing_norm': frozenset({'view', 'create', 'update', 'delete', 'export'}),
    'costing_so': frozenset({'view', 'create', 'update', 'delete', 'export'}),
    'actual_cost': frozenset({'view', 'export'}),
    'traceability': frozenset({'view'}),
    'ops_report': frozenset({'view', 'export'}),
    'process': frozenset({'view'}),
    'unified_catalog': frozenset({'view', 'update'}),
    'staging': frozenset({'view', 'create', 'update', 'delete'}),
    'general_settings': frozenset({'view', 'update'}),
}


def submenu_supported_actions(module_key: str, menu_key: str) -> frozenset[str]:
