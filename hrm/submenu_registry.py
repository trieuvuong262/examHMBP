...
MODULE_SUBMENUS: dict[str, list[dict]] = {
    ...
    MODULE_KHO_NPL: [
        {'key': 'overview', 'label': 'Tổng quan tồn kho', 'icon': 'bi-speedometer2'},
        {'key': 'materials', 'label': 'Danh mục nguyên phụ liệu', 'icon': 'bi-tags'},
        {'key': 'material_stock', 'label': 'Tồn kho nguyên phụ liệu', 'icon': 'bi-boxes'},
        {'key': 'stock_cards', 'label': 'Thẻ kho', 'icon': 'bi-grid-3x3-gap'},
        {'key': 'receipts', 'label': 'Phiếu nhập kho', 'icon': 'bi-box-arrow-in-down'},
        {'key': 'issues', 'label': 'Phiếu xuất kho', 'icon': 'bi-box-arrow-up'},
        {'key': 'transfers', 'label': 'Chuyển kho', 'icon': 'bi-arrow-left-right'},
        {'key': 'disposals', 'label': 'Phiếu hủy', 'icon': 'bi-trash3'},
        {'key': 'adjustments', 'label': 'Điều chỉnh tồn kho', 'icon': 'bi-sliders'},
        {'key': 'stocktakes', 'label': 'Kiểm kê kho', 'icon': 'bi-clipboard-check'},
