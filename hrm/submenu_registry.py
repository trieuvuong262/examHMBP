...
MODULE_SUBMENUS: dict[str, list[dict]] = {
    ...
    MODULE_SAN_XUAT: [
        ...
        {'key': 'schedule', 'label': 'Lịch SX', 'icon': 'bi-calendar-week'},
        {'key': 'material_issue_req', 'label': 'Yêu cầu xuất vật tư', 'icon': 'bi-box-arrow-right'},
        {'key': 'prod_stats', 'label': 'Thống kê SX', 'icon': 'bi-bar-chart'},
        ...
        {'key': 'downtime', 'label': 'Dừng chuyền / hiệu suất', 'icon': 'bi-pause-circle'},
        ...
        {'key': 'costing', 'label': 'Giá thành', 'icon': 'bi-calculator'},
...
MENU_PATH_RULES: list[tuple[str, str, str]] = [
    ...
    ('/san-xuat/nang-luc/tai-theo-to', MODULE_SAN_XUAT, 'capacity'),
