...
MODULE_SUBMENUS: dict[str, list[dict]] = {
    ...
    MODULE_SAN_XUAT: [
        ...
        {'key': 'plan_progress', 'label': 'Giám sát tiến độ', 'icon': 'bi-clipboard-data'},
        ...
        {'key': 'team_work_cat', 'label': 'Cắt', 'icon': 'bi-scissors'},
        {'key': 'team_work_inep', 'label': 'In - Ép', 'icon': 'bi-printer'},
        {'key': 'team_work_theu', 'label': 'Thêu', 'icon': 'bi-flower1'},
        {'key': 'team_work_may', 'label': 'May', 'icon': 'bi-grid-3x3-gap'},
        {'key': 'team_work_ht', 'label': 'Ủi - Gấp xếp', 'icon': 'bi-layers'},
        {'key': 'team_work_gh', 'label': 'Giao hàng thành phẩm', 'icon': 'bi-truck'},
