"""Seed menu: Thời gian trung gian (plan_inter_step)."""

from django.db import migrations

NEW_MENU_KEYS = ('plan_inter_step',)
...
def seed_forward(apps, schema_editor):
    ...
    for group in PermissionGroup.objects.all():
        ...
        if not menus:
            continue
        source = menus.get('plan_board') or menus.get('plan') or {}
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('hrm', '0098_seed_kho_sp_stock_menu'),
    ]
