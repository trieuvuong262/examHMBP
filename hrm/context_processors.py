...
def portal_permissions(request):
    ...
    if not user.is_authenticated:
        return {
            ...
            'jp_can_edit_surveys': False,
            'jp_can_create_surveys': False,
            'jp_can_update_surveys': False,
            'jp_can_delete_surveys': False,
    ...
    base = {
        ...
        'jp_can_edit_san_xuat': user_can_edit_module(user, MODULE_SAN_XUAT),
        ...
        'jp_can_edit_surveys': user_can_edit_module(user, MODULE_SURVEYS),
        'jp_can_create_surveys': user_can_create_module(user, MODULE_SURVEYS),
        'jp_can_update_surveys': user_can_update_module(user, MODULE_SURVEYS),
        'jp_can_delete_surveys': user_can_delete_module(user, MODULE_SURVEYS),
        'jp_can_edit_utilities': user_can_edit_module(user, MODULE_UTILITIES),
        'jp_can_create_utilities': user_can_create_module(user, MODULE_UTILITIES),
        'jp_can_update_utilities': user_can_update_module(user, MODULE_UTILITIES),
        'jp_can_delete_utilities': user_can_delete_module(user, MODULE_UTILITIES),
        'jp_can_export_utilities': user_can_export_module(user, MODULE_UTILITIES),
