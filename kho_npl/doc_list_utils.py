...
RECEIPT_STATUS_FILTER_CHOICES = (
    ('', 'Tất cả'),
    (DOC_STATUS_DRAFT, RECEIPT_STATUS_LABELS[DOC_STATUS_DRAFT]),
    (DOC_STATUS_POSTED, RECEIPT_STATUS_LABELS[DOC_STATUS_POSTED]),
    (DOC_STATUS_CANCELLED, RECEIPT_STATUS_LABELS[DOC_STATUS_CANCELLED]),
)

ISSUE_STATUS_FILTER_CHOICES = (
    ('', 'Tất cả'),
    (DOC_STATUS_DRAFT, ISSUE_STATUS_LABELS[DOC_STATUS_DRAFT]),
    (DOC_STATUS_POSTED, ISSUE_STATUS_LABELS[DOC_STATUS_POSTED]),
    (DOC_STATUS_CANCELLED, ISSUE_STATUS_LABELS[DOC_STATUS_CANCELLED]),
)
